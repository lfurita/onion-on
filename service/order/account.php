    ...
    <div class="sub-conts-wrap">
        <div class="wrap">
            ...
            <div class="table-wrap">
                ...
                <!-- Table start -->
                <div class="table-box">
                    <table class="table-line" style="width: 1829px;">
                        <colgroup>
                            <col width="40px"> <!--/* 체크박스 */-->
                            ...
                            <col width="270px"> <!--/* 배송지 주소 */-->
                            <col width="100px"> <!--/* 구매자명 */-->
                            <col width="120px"> <!--/* 연락처 */-->
                            <col width="120px"> <!--/* 상품바코드 */-->

                            <col width="120px"> <!--/* 이중바코드 */-->
                            <col width="120px"> <!--/* 상품명 */-->
                            <col width="70px"> <!--/* 규격 */-->
                            <col width="80px"> <!--/* 총수량 */-->
                            <col width="90px"> <!--/* 제품확인 */-->
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td rowspan="4">01</td>
                                <td rowspan="4" class="rgstr">접수</td>
                                <td rowspan="4">2023.12.01 13:00</td>
                                <td rowspan="4">2023.12.01 13:00</td>
                                <td rowspan="4">2313134242</td>

                                <td rowspan="4">카카오</td>
                                <td class="left" rowspan="4">서울시 구로구 경인로 661,<br>
                                신도림 1차푸르지오 101동 18층<br>
                                (신도림동, 핀포인트타워)1</td>
                                <td rowspan="4">홍길동</td>
                                <td rowspan="4">010-3271-5555</td>
                                <td>8812345678123</td>
